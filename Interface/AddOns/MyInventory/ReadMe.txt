...
Compatability: (Latest tested verions)
* EquipCompare ( v 2.6.2): Works
* AuctionIt ( v 0.8.2): Works, some slight quirks with the open at options
* ItemsMatrix (v 5.4): Works - has extra code for MI that doesn't need to be there
* Auctioneer (v 3.0 edited): Works - I think it has some useless code too
* LootLink (v 1.4.0): Works
* Enchantrix (v 1.14): [I don't enchant, so could someone let me know?]
* ReagentInfo (v 1.3.2): Should work fine
Compatability notes: The issues with Auctioneer IM, and other addon's adding tooltip data isn't much of anything I can support. I'd really like to talk to all the Authors who add data to tooltips and come up with a standard.